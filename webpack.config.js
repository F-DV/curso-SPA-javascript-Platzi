...
module.exports = {  //Aquí se encuentra toda la configuración de lo que va a suceder. Modulo para exportar.
    ...
    output: { //Donde se envía el proyecto estructurado y compilado listo para producción.
        path: path.resolve(__dirname, 'dist'),  //Creamos el lugar dónde se exportará el proyecto y la carpeta que creara
    ...
    module: { //Se crea un modulo con las reglas necesarias que vamos a utilizar.
        rules: [    //Reglas
            {   // Estructura de Babel
                test: /\,js?$/, //Nos permite identificar los archivos según se encuentran en nuestro entorno.Archivos .js
        ...
        new HtmlWebpackPlugin([    //Permite trabajar con los archivos HTML
            {
                ...
                template: './public/index.html',    //Dirección donde se encuentra el template principal o HTML principal
